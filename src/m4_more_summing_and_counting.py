...
def run_test_count_cosines_from():
    ...
    expected = 4
    answer = count_cosines_from(5, 15, 0.29)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(30, 33, 0.40)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(50, 57, 0.12)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(26, 29, 0.20)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(80, 86, 0.50)
    ...
    expected = 1
    answer = count_cosines_from(70, 74, 0.50)
    print('Test 7 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(62, 68, 0.50)
    ...
    expected = 1
    answer = count_cosines_from(10, 13, 0.50)
    print('Test 10 expected:', expected)
    print('       actual:  ', answer)

    expected = 0
    answer = count_cosines_from(15, 18, 0.50)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.569877  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 11)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.545635  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 13)
    ...
    expected = 1.269877  # This is APPROXIMATELY the correct answer.
